...
std::vector<Checkers::Move> Checkers::allowedMoves(
    ...
    const std::string &color)
{
    /*
        ...
        Return value:
        It must return a vector of all the valid moves. Please refer to the
        README for a description of what are valid moves. A move is a vector of
...
Checkers::Move Checkers::play(const std::vector<std::string> &board, const std::string &color)
{
    return {};
}
